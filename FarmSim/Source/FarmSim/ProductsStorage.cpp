...
AProductsStorage::AProductsStorage()
{
	...
	auto MeshAsset = ConstructorHelpers::FObjectFinder<UStaticMesh>(TEXT("/Game/StylizedProvencal/Meshes/SM_Barrel.SM_Barrel"));
...
void AProductsStorage::BeginPlay()
{
	Super::BeginPlay();
...
void AProductsStorage::Tick(float DeltaTime)
{
